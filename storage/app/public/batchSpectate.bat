rem EVILSPARTAN.COM Spectate
SETLOCAL enableextensions enabledelayedexpansion 
@echo off

echo -----------------------
echo Spectate by www.evilspartan.com
echo -----------------------

set RADS_PATH="{$leaguePath}"
...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator spectator.{$region}.lol.riotgames.com:80 {$encryptionKey} {$matchId} {$platformId}" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
...
echo ===================
echo {$region}: LOL 
echo EN: Cannot found LOL directory path for automatic. Please see our spectate help page: https://www.evilespartan.com/help/spectator
echo ===================
@pause
